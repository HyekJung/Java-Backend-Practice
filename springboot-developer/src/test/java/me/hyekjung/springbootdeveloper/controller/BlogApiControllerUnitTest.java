...
class BlogApiControllerUnitTest {
    ...
    public void mockMvcSetUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(blogApiController).build();
    }
    ...
    public void getAllArticles() throws Exception {
        ...
        Page<Article> page = new PageImpl<>(articleList, pageable, articleList.size());
